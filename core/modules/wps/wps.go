...
// Implementa a interface GRCModule para o WpsManager
func (w *WpsManager) GetID() string          { return "wps" }
func (w *WpsManager) GetName() string        { return "WPS Office" }
func (w *WpsManager) GetDescription() string { return "Suíte de produtividade." }
func (w *WpsManager) GetIconSVG() string {
...
func (w *WpsManager) RunSilent() error {
	return w.Deploy(false)
}
